...
class Debug{
	...
	static function message(){
		echo '<div style="float:left;clear:both;text-align:left;font-size:12px;font-family:Arial;color:#888;width:95%;margin:10px;padding:10px;background:#F8F8F8;border:1px dotted #E7E5DC;z-index:100">';
		echo '<div style="float:left;width:100%;"><span style="float:left;width:250px;"><b>运行信息</b>( 页面执行时间<font color="red"> '.self::spent().' </font>秒）：</span><span onclick="this.parentNode.parentNode.style.display=\'none\'" style="cursor:pointer;float:right;width:45px;text-align:center;background:#E56155;color:white">CLOSE</span></div><br>';
